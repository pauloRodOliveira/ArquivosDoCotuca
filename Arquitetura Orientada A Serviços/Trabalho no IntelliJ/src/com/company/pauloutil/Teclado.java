...
public class Teclado
{
    ...
    public static byte getUmByte(byte a, byte b) throws Exception{
        byte ret = Teclado.getUmByte();
        try {
            if (ret < a || ret > b) throw new Exception("Byte inválido escolha entre " + a + " e " + b + ".");
        }catch (NumberFormatException erro){
